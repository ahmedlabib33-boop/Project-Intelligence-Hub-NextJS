...
LINEAGE = [
    ...
    item("Delay Analysis - TIA", "Uploads", "Recognized file inventory and include/exclude controls", "01-13 Delay TIA CSV files", "all source columns + project_id + source_file + source_folder + source_row", "Inspect selected project's Delay TIA folder only", "dashboard.build_steel_delay_template_inventory_df", source_folder="02-delay_analysis/unified_tia_csv"),
    item("Delay Analysis - TIA", "Tables & Conclusion", "Canonical source tables and conclusion", "01-13 Delay TIA CSV files", "metadata, activity, supply, P6, relationships, clauses, IFC, payments, RFI, concurrency", "Build event/activity/supply/concurrency context without cross-project fallback", "dashboard.build_delay_tia_analysis_context", source_folder="02-delay_analysis/unified_tia_csv"),
    ...
    item("Delay Analysis - TIA", "AI - TIA", "Readiness, fragnet, causation, concurrency, EOT", "02,03,04,05,06,07,08,09,10,11 CSVs", "event ID, activity ID, float, critical, longest path, overlap, evidence", "Hybrid retrospective TIA rules and selected-project source trace", "steel_delay_tia.run_steel_delay_tia_analysis", source_folder="02-delay_analysis/unified_tia_csv"),
