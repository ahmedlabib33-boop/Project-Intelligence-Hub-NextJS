...
def build_master_dashboard_html(
    ...
    def section(section_id: str, title: str, subtitle: str, body: str, active: bool = False) -> str:
        active_class = " active" if active else ""
        return (
            f"<section id='{section_id}' class='md-section{active_class}'>"
...
def style_plotly(fig, height=390):
    fig.update_layout(
        ...
        xaxis=dict(gridcolor="#edf3f6", zerolinecolor="#dde7ef"),
        yaxis=dict(gridcolor="#edf3f6", zerolinecolor="#dde7ef"),
    )
    return fig
...
def render_ai_status_note(ai_status: dict | None):
    ...
    if status == "ok":
        ...
        st.warning("AI enhancement was unavailable; the local contract intelligence result was used.")
